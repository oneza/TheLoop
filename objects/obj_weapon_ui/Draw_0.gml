if (object_exists(obj_player_weapon))
{
	...
	draw_text_colour(ui_placement_x + 20, ui_placement_y - 50, string(obj_game.weapon_current_capacity[current_weapon]) + "/" + string(obj_game.weapon_total_ammo[current_weapon]), c_white, c_white, c_white, c_white, 1);
