...
if (room != rm_death && room != rm_startscreen && room != rm_mainmenu)
{
	...
	if(global.gameIsPaused){
		...
		instance_create_layer(x_for_pause, y_for_pause + 130, "UI", obj_pause_resumebutton);
		instance_create_layer(x_for_pause, y_for_pause + 200, "UI", obj_pause_mmbutton);
